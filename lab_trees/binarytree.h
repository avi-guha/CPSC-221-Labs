...
struct BinaryTree
{
  ...
  private:
     ...
     * @return The sum of distances for the subtree.
     */
     ...
     * @param subRoot The current node in the recursion.
     * @param prev Pointer to the previous value in in-order traversal.
     * @return True if the subtree is ordered.
     */
    bool isOrdered(const Node* subRoot, T*& prev) const;
